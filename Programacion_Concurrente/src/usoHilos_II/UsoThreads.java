...
class MarcoRebote extends JFrame{
	public MarcoRebote(){
		...
		//Boton de detener - se ha agregado
		ponerBoton(laminaBotones, "Detener", new ActionListener(){////escucha del evento
				public void actionPerformed(ActionEvent evento){
					//Metodo, que vamos a construir
					detener();
				}
		});
	...
	public void comienza_el_juego (){		
			...
			t = new Thread(r);
			//Paso 5
			//comienza la ejecucion del hilo, llama al metodo run() y 
			//lo hace para la instancia de la clase thread (t)
			t.start(); 
	...
	//variable objeto, de tipo t.para que sea accesible desde cualquie metodo.
	Thread t;
